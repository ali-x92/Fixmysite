...
//#endregion
//#region node_modules/@opentelemetry/instrumentation-amqplib/build/src/types.js
var require_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	})(exports.EndOperation || (exports.EndOperation = {}));
...
//#endregion
//#region node_modules/@opentelemetry/instrumentation-amqplib/build/src/utils.js
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var extractConnectionAttributeOrLog = (url, attributeKey, attributeValue, nameForLog) => {
		if (attributeValue) return { [attributeKey]: attributeValue };
		else {
			api_1.diag.error(`amqplib instrumentation: could not extract connection attribute ${nameForLog} from user supplied url`, { url });
			return {};
		}
	};
	var getConnectionAttributesFromServer = (conn) => {
		...
		if (product) return { [semantic_conventions_1.SEMATTRS_MESSAGING_SYSTEM]: product };
		else return {};
	};
	exports.getConnectionAttributesFromServer = getConnectionAttributesFromServer;
	var getConnectionAttributesFromUrl = (url) => {
		const attributes = { [semantic_conventions_1.SEMATTRS_MESSAGING_PROTOCOL_VERSION]: "0.9.1" };
...
//#endregion
//#region node_modules/@opentelemetry/instrumentation-amqplib/build/src/amqplib.js
var require_amqplib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var AmqplibInstrumentation = class extends instrumentation_1.InstrumentationBase {
		...
		init() {
			...
			return new instrumentation_1.InstrumentationNodeModuleDefinition("amqplib", supportedVersions, void 0, void 0, [
		...
		patchConnect(moduleExports) {
			...
			if (!(0, instrumentation_1.isWrapped)(moduleExports.connect)) this._wrap(moduleExports, "connect", this.getConnectPatch.bind(this));
			return moduleExports;
		}
		unpatchConnect(moduleExports) {
			if ((0, instrumentation_1.isWrapped)(moduleExports.connect)) this._unwrap(moduleExports, "connect");
			return moduleExports;
		}
		patchChannelModel(moduleExports, moduleVersion) {
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.publish)) this._wrap(moduleExports.Channel.prototype, "publish", this.getPublishPatch.bind(this, moduleVersion));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.consume)) this._wrap(moduleExports.Channel.prototype, "consume", this.getConsumePatch.bind(this, moduleVersion));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.ack)) this._wrap(moduleExports.Channel.prototype, "ack", this.getAckPatch.bind(this, false, types_1.EndOperation.Ack));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.nack)) this._wrap(moduleExports.Channel.prototype, "nack", this.getAckPatch.bind(this, true, types_1.EndOperation.Nack));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.reject)) this._wrap(moduleExports.Channel.prototype, "reject", this.getAckPatch.bind(this, true, types_1.EndOperation.Reject));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.ackAll)) this._wrap(moduleExports.Channel.prototype, "ackAll", this.getAckAllPatch.bind(this, false, types_1.EndOperation.AckAll));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.nackAll)) this._wrap(moduleExports.Channel.prototype, "nackAll", this.getAckAllPatch.bind(this, true, types_1.EndOperation.NackAll));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.emit)) this._wrap(moduleExports.Channel.prototype, "emit", this.getChannelEmitPatch.bind(this));
			if (!(0, instrumentation_1.isWrapped)(moduleExports.ConfirmChannel.prototype.publish)) this._wrap(moduleExports.ConfirmChannel.prototype, "publish", this.getConfirmedPublishPatch.bind(this, moduleVersion));
			return moduleExports;
		}
		unpatchChannelModel(moduleExports) {
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.publish)) this._unwrap(moduleExports.Channel.prototype, "publish");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.consume)) this._unwrap(moduleExports.Channel.prototype, "consume");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.ack)) this._unwrap(moduleExports.Channel.prototype, "ack");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.nack)) this._unwrap(moduleExports.Channel.prototype, "nack");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.reject)) this._unwrap(moduleExports.Channel.prototype, "reject");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.ackAll)) this._unwrap(moduleExports.Channel.prototype, "ackAll");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.nackAll)) this._unwrap(moduleExports.Channel.prototype, "nackAll");
			if ((0, instrumentation_1.isWrapped)(moduleExports.Channel.prototype.emit)) this._unwrap(moduleExports.Channel.prototype, "emit");
			if ((0, instrumentation_1.isWrapped)(moduleExports.ConfirmChannel.prototype.publish)) this._unwrap(moduleExports.ConfirmChannel.prototype, "publish");
			return moduleExports;
		}
		...
		getChannelEmitPatch(original) {
			...
			return function emit(eventName) {
				...
				} else if (eventName === "error") self.endAllSpansOnChannel(this, true, types_1.EndOperation.ChannelError, void 0);
		...
		getAckPatch(isRejected, endOperation, original) {
			...
			return function ack(message, allUpToOrRequeue, requeue) {
				...
				if (msgIndex < 0) self.endConsumerSpan(message, isRejected, endOperation, requeueResolved);
				else if (endOperation !== types_1.EndOperation.Reject && allUpToOrRequeue) {
					for (let i = 0; i <= msgIndex; i++) self.endConsumerSpan(spansNotEnded[i].msg, isRejected, endOperation, requeueResolved);
			...
			return function consume(queue, onMessage, options) {
				...
				const patchedOnMessage = function(msg) {
					...
					if (self._config.useLinksForConsume) {
						...
						if (parentSpanContext) links = [{ context: parentSpanContext }];
					}
					...
					if (consumeHook) (0, instrumentation_1.safeExecuteInTheMiddle)(() => consumeHook(span, {
						moduleVersion,
						msg
					}), (e) => {
						if (e) api_1.diag.error("amqplib instrumentation: consumerHook error", e);
					}, true);
		...
		getConfirmedPublishPatch(moduleVersion, original) {
			...
			return function confirmedPublish(exchange, routingKey, content, options, callback) {
				...
				if (publishHook) (0, instrumentation_1.safeExecuteInTheMiddle)(() => publishHook(span, {
					moduleVersion,
					exchange,
					routingKey,
					content,
					...
					if (e) api_1.diag.error("amqplib instrumentation: publishHook error", e);
				}, true);
				const patchedOnConfirm = function(err, ok) {
					try {
						callback === null || callback === void 0 || callback.call(this, err, ok);
					} finally {
						...
						if (publishConfirmHook) (0, instrumentation_1.safeExecuteInTheMiddle)(() => publishConfirmHook(span, {
							...
							if (e) api_1.diag.error("amqplib instrumentation: publishConfirmHook error", e);
						}, true);
		...
		getPublishPatch(moduleVersion, original) {
			...
			return function publish(exchange, routingKey, content, options) {
				if ((0, utils_1.isConfirmChannelTracing)(api_1.context.active())) return original.apply(this, arguments);
				else {
					const channel = this;
					const { span, modifiedOptions } = self.createPublishSpan(self, exchange, routingKey, channel, options);
					const { publishHook } = self.getConfig();
		...
		endAllSpansOnChannel(channel, isRejected, operation, requeue) {
			var _a;
			((_a = channel[utils_1.CHANNEL_SPANS_NOT_ENDED]) !== null && _a !== void 0 ? _a : []).forEach((msgDetails) => {
		...
		callConsumeEndHook(span, msg, rejected, endOperation) {
			...
			(0, instrumentation_1.safeExecuteInTheMiddle)(() => consumeEndHook(span, {
				...
				if (e) api_1.diag.error("amqplib instrumentation: consumerEndHook error", e);
			}, true);
		}
		checkConsumeTimeoutOnChannel(channel) {
			...
			for (i = 0; i < spansNotEnded.length; i++) {
				...
				if ((0, core_1.hrTimeToMilliseconds)(timeFromConsume) < consumeTimeoutMs) break;
...
//#endregion
//#region node_modules/@opentelemetry/instrumentation-amqplib/build/src/index.js
