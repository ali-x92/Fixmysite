import { i as __require, r as __exportAll, t as __commonJSMin } from "../../_runtime.mjs";
...
//#endregion
//#region node_modules/tar-fs/index.js
...
//#endregion
//#region node_modules/@sparticuz/chromium/build/esm/index.mjs
...
*/
var isRunningInAmazonLinux2023 = (nodeMajorVersion) => {
...
var downloadAndExtract = async (url) => {
	...
	try {
		await pipeline(Readable.fromWeb(response.body), (0, import_tar_fs.extract)(destDir));
	} catch (error) {
...
var inflate = (filePath) => {
	...
	return new Promise((resolve, reject) => {
		...
		if (isTar) {
			target = (0, import_tar_fs.extract)(output);
			target.once("finish", () => {
				resolve(output);
			});
		} else {
